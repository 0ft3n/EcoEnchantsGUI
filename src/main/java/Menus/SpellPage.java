...
public class SpellPage {
    ...
    public Inventory getMenu(int page){
        ...
        int guiSize = Main.getConfigInt("menus.page-spell.size");

        Inventory mainMenu = null;

        for (String button: Main.getConfigKeys("menus.page-spell.buttons", false)){
            List<Integer> intSlots = Main.getConfigIntList("menus.page-spell.buttons."+button+".slots");
            String type = Main.getConfigString("menus.page-spell.buttons."+button+".type");
            if (type.equalsIgnoreCase("ENCHANTMENT")){
                pageCount = intSlots.size();
                nextActive = page<getMaxPages();
                prevActive = page>1;
                String guiName = ColorUtils.colorMessage(Main.getConfigString("menus.page-spell.title")
    ...
    public ItemStack getEnchantmentItem(String name, EcoEnchant e){
        ...
        ItemStack button;
        String materialString = Main.getConfigString("menus.page-spell.buttons."+name+".material");
        String itemName = replaceItemVars(Main.getConfigString("menus.page-spell.buttons."+name+".name"), e);
        List<String> itemLore = new ArrayList<>();
        boolean isGlowing = Main.getConfigBoolean("menus.page-spell.buttons."+name+".glowing");
        for (String line: Main.getConfigStringList("menus.page-spell.buttons."+name+".lore")){
        ...
        int modelData = Main.getConfigInt("menus.page-spell.buttons."+name+".custom-model-data");
    ...
    public ItemStack getItem(String name){
        ItemStack button;
        String type = Main.getConfigString("menus.page-spell.buttons."+name+".type").toUpperCase();
        ...
        if (type.equalsIgnoreCase("NEXTPAGE")){
            if (nextActive){
                materialString = Main.getConfigString("menus.page-spell.buttons."+name+".material-active");
                itemName = ColorUtils.colorMessage(Main.getConfigString("menus.page-spell.buttons."+name+".name-active"));
                isGlowing = Main.getConfigBoolean("menus.page-spell.buttons."+name+".glowing-active");
                for (String line: Main.getConfigStringList("menus.page-spell.buttons."+name+".lore-active")){
                    itemLore.add(ColorUtils.colorMessage(line));
                }
            }
            else {
                materialString = Main.getConfigString("menus.page-spell.buttons."+name+".material-inactive");
                itemName = ColorUtils.colorMessage(Main.getConfigString("menus.page-spell.buttons."+name+".name-inactive"));
                isGlowing = Main.getConfigBoolean("menus.page-spell.buttons."+name+".glowing-inactive");
                for (String line: Main.getConfigStringList("menus.page-spell.buttons."+name+".lore-inactive")){
                    itemLore.add(ColorUtils.colorMessage(line));
                }
            }
        }
            ...
            materialString = Main.getConfigString("menus.page-spell.buttons."+name+".material");
            itemName = ColorUtils.colorMessage(Main.getConfigString("menus.page-spell.buttons."+name+".name"));
            isGlowing = Main.getConfigBoolean("menus.page-spell.buttons."+name+".glowing");
            for (String line: Main.getConfigStringList("menus.page-spell.buttons."+name+".lore")){
                itemLore.add(ColorUtils.colorMessage(line));
            }
        }
