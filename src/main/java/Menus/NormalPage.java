...
public class NormalPage {
    ...
    public Inventory getMenu(int page){
        ...
        int guiSize = Main.getConfigInt("menus.page-normal.size");

        Inventory mainMenu = null;

        for (String button: Main.getConfigKeys("menus.page-normal.buttons", false)){
            List<Integer> intSlots = Main.getConfigIntList("menus.page-normal.buttons."+button+".slots");
            String type = Main.getConfigString("menus.page-normal.buttons."+button+".type");
            if (type.equalsIgnoreCase("ENCHANTMENT")){
                pageCount = intSlots.size();
                nextActive = page<getMaxPages();
                prevActive = page>1;
                String guiName = ColorUtils.colorMessage(Main.getConfigString("menus.page-normal.title")
    ...
    public ItemStack getEnchantmentItem(String name, EcoEnchant e){
        ...
        ItemStack button;
        String materialString = Main.getConfigString("menus.page-normal.buttons."+name+".material");
        String itemName = replaceItemVars(Main.getConfigString("menus.page-normal.buttons."+name+".name"), e);
        List<String> itemLore = new ArrayList<>();
        boolean isGlowing = Main.getConfigBoolean("menus.page-normal.buttons."+name+".glowing");
        for (String line: Main.getConfigStringList("menus.page-normal.buttons."+name+".lore")){
        ...
        int modelData = Main.getConfigInt("menus.page-normal.buttons."+name+".custom-model-data");
    ...
    public ItemStack getItem(String name){
        ItemStack button;
        String type = Main.getConfigString("menus.page-normal.buttons."+name+".type").toUpperCase();
        ...
        if (type.equalsIgnoreCase("NEXTPAGE")){
            if (nextActive){
                materialString = Main.getConfigString("menus.page-normal.buttons."+name+".material-active");
                itemName = ColorUtils.colorMessage(Main.getConfigString("menus.page-normal.buttons."+name+".name-active"));
                isGlowing = Main.getConfigBoolean("menus.page-normal.buttons."+name+".glowing-active");
                for (String line: Main.getConfigStringList("menus.page-normal.buttons."+name+".lore-active")){
                    itemLore.add(ColorUtils.colorMessage(line));
                }
            }
            else {
                materialString = Main.getConfigString("menus.page-normal.buttons."+name+".material-inactive");
                itemName = ColorUtils.colorMessage(Main.getConfigString("menus.page-normal.buttons."+name+".name-inactive"));
                isGlowing = Main.getConfigBoolean("menus.page-normal.buttons."+name+".glowing-inactive");
                for (String line: Main.getConfigStringList("menus.page-normal.buttons."+name+".lore-inactive")){
                    itemLore.add(ColorUtils.colorMessage(line));
                }
            }
        }
            ...
            materialString = Main.getConfigString("menus.page-normal.buttons."+name+".material");
            itemName = ColorUtils.colorMessage(Main.getConfigString("menus.page-normal.buttons."+name+".name"));
            isGlowing = Main.getConfigBoolean("menus.page-normal.buttons."+name+".glowing");
            for (String line: Main.getConfigStringList("menus.page-normal.buttons."+name+".lore")){
                itemLore.add(ColorUtils.colorMessage(line));
            }
        }
